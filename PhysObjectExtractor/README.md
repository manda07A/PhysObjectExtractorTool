...
If you have access to an HTCondor cluster that can run containers, these steps will guide you through submitting batch jobs over full datasets

1. Modify the submit_jobs.sh with the appropriate base path
1. 
